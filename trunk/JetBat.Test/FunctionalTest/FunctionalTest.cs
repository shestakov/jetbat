...
namespace JetBat.Test.FunctionalTest
{
	public class FunctionalTest
	{
		...
		private int goodCategoryOne;
		private int goodCategoryTwo;
		private int goodOne;
		private int goodTwo;
		private int goodThree;
		private int goodFour;
		private int dishCategory;
		private int dishOne;
		private int dishTwo;
		private int dishThree;
		private int calcDay;
		private int incomeDocument;
		private int menu;
		private int mealTimeOne;
		private int mealTimeTwo;
		private int mealTimeThree;
		...
		public FunctionalTest(IAccessAdapter adapter)
		{
		...
		{
			#region Measure Units (1)

			measureUnit = BusinessObjectHelper.CreatePlainObject(adapter, "MealCalc", "MeasureUnit",
			                                                 ...
			                                                 delegate(ObjectInstance instance)
			                                                 	{
			                                                 		...
			                                                 		instance["MeasureUnitID"] = measureUnit;
			                                       ...
			                                       delegate(ObjectInstance instance)
			                                       	{
			                                       		...
			                                       		instance["Quantity"] = (decimal)1000;
			                                       ...
			                                       delegate(ObjectInstance instance)
			                                       	{
			                                       		instance["DocumentVersionID"] = documentInstance.VersionID;
			                                       		instance["GoodID"] = goodThree;
			                                       		instance["GoodCommodityName"] = "Торговое наименование третьего товара";
			                                       		instance["Price"] = (decimal)3000;
			                                       		instance["Quantity"] = (decimal)1000;
			                                       		instance["Comment"] = "Комментарий к товарной позиции";
			                                       		instance["OrderNumber"] = DBNull.Value;
			                                       	});
		...
		private void checkGoodBalance()
		{
			...
			Assert.AreEqual(4, storedQueryDefinition.Attributes.Count);
		}
