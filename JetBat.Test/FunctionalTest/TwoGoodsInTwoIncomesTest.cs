...
{
	public class TwoGoodsInTwoIncomesTest : MealCalcFunctionalTest
	{
		...
		public TwoGoodsInTwoIncomesTest(IAccessAdapter adapter) : base(adapter)
		{
		}
